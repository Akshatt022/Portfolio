...
const experience = document.querySelector('.list3');
const experienceh3 = document.querySelector('.experience')
const list1 = ()=>{
  aboutpara.style.opacity=1
  about.style.borderBottom=`3px solid red`
  skill.style.borderBottom = '0'
  skillimage.style.opacity=0
  experience.style.borderBottom='0'
  experienceh3.style.opacity=0
}
const list2=()=>{
...
const list3 =()=>{
  ...
  skill.style.borderBottom = '0'
  skillimage.style.opacity=0
  experience.style.borderBottom='3px solid red'
  experienceh3.style.opacity=1
}
